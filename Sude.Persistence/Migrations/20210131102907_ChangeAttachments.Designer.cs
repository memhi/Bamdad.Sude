...
namespace Sude.Persistence.Migrations
{
    ...
    [Migration("20210131102907_ChangeAttachments")]
    partial class ChangeAttachments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sude.Domain.Models.Common.AttachmentInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("AttachmentFileAddress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Sude.Domain.Models.Localization.LanguageInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sude.Domain.Models.Localization.LocalStringResourceInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LocalStringResources");
                });
            ...
            modelBuilder.Entity("Sude.Domain.Models.Work.WorkUserInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sude.Domain.Models.Common.AttachmentInfo", b =>
                {
                    b.HasOne("Sude.Domain.Models.Type.TypeInfo", "AttachmentType")
                        .WithMany()
            ...
            modelBuilder.Entity("Sude.Domain.Models.Localization.LocalStringResourceInfo", b =>
                {
                    b.HasOne("Sude.Domain.Models.Localization.LanguageInfo", "Language")
                        .WithMany("LocalStringResources")
            ...
            modelBuilder.Entity("Sude.Domain.Models.Localization.LanguageInfo", b =>
                {
                    b.Navigation("LocalStringResources");
                });
